...
- [screenshot-evidence.md](screenshot-evidence.md)
  说明截图如何通过 `image-specs` / image map 嵌入报告，如何写图注和放置位置。

## 演示与发布

- [one-click-demo.md](one-click-demo.md)
  说明仓库自带的一键演示怎么跑、会产出什么、如何替换成自己的材料。

- [course-design-fastline.md](course-design-fastline.md)
  说明课程设计报告为什么需要显式 profile，以及推荐命令和升级检查时机。

- [social-launch-kit.md](social-launch-kit.md)
  给 GitHub / 小红书 / 抖音准备的发布建议、标题方向和素材清单。

- [GITHUB_LAUNCH.md](GITHUB_LAUNCH.md)
  GitHub 仓库简介、标签、首个 release 和 social preview 的准备清单。
